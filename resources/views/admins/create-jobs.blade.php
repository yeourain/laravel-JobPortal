            ...
            <div class="card-body">
                ...
                <form class="p-4 p-md-5" action="{{ route('store.jobs') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="job_title" class="form-control" id="job-title" placeholder="e.g. Product Designer">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="category" class="selectpicker border rounded form-control " id="" data-style="btn-black" data-width="100%" data-live-search="true" title="Select Category">
